...
config_file_path = r"C:\Users\User\AppData\Roaming\BetterDiscord\plugins\Asterea.config.json"
config_file_path2 = r"C:\Users\User\AppData\Roaming\BetterDiscord\plugins\Asterea.config.json"
                ...
                with open(file_path, "r") as file:
                    ...
                    if "offline" in last_line:
                        if y == "offline":
                            ...
                            ST.execute_scene(ST.scenes['Home']['Ashley8'])
                            y == "offline"
